	...
	<body class="fixed">
        ...
        <header>
			<a href="<?php echo base_url(); ?>" class="logo">
            	<img alt="" src="<?php echo base_url(); ?>assets/img/logo_small.png" style="max-height:100%;" /> <span><b>ABC</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown widget-user">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?php echo base_url(); ?>assets/img/logo_small.png" class="pull-left" alt="image" />
